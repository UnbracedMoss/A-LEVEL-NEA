...
def login_verify():
    ...
    if username1 in list_of_files:
        ...
        counter = int(counter) # Assigning the integer value of the variable "counter" to the variable "counter"
        presence_counter = int(presence_counter) # Assigning the integer value of the variable "presence_counter" to the variable "presence_counter"
        if counter == 3 and presence_counter != 0: # Initialising a conditional statement based on the values of the variable "counter" and "presence_counter"
          # If the value of the variable "counter" equals 3, it means that all the required fields of login is correct
          # If the value of the variable "presence_counter" equals 0, it means that there are no missing required fields
          # Once these conditions are met, the user should be able to login
            login_success()
            print(presence_counter)
        else:
          # If the value of the variable "counter" does not equal 3, it means that one , or more, of the required fields of login is incorrect
          # If the value of the variable "presence_counter" does not equal 0, it means that there are missing entries for the required fields
          # This means that the user should not be able to login
            password_not_recognised()
...
def main_screen():
    global screen # Defining the screen
    global ORIGINAL_ROOT_DIR # Globalising the variable "ORIGINAL_ROOT_DIR" (root directory)
    global path_for_reviews # Globalising the variable "path_for_reviews" (Reviews directory)
    ...
    global path_for_motorvehicles # Globalising the variable "path_for_motorvehicles" (Motorvehicles directory)
    ...
    global presence_counter # Globalising the variable "presence_counter"
    presence_counter = 0 # Assigning the value "0" to the variable "presence_counter"
    screen=Tk()
