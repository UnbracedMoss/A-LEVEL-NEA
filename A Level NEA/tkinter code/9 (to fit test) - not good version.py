...
def store_products():
    ...
    product1 = product_entry.get() # Assigning the value of the variable "product_entry" to "product1"
    price1 = price_entry.get() # Assigning the value of the variable "price_entry" to "price1"
    category1 = clicked.get() # Assigning the value of the variable "clicked" to "category1"
    keyword1 = keyword1_entry.get() # Assigning the value of the variable "keyword1_entry" to "keyword1"
    keyword2 = keyword2_entry.get() # Assigning the value of the variable "keyword2_entry" to "keyword2"
    keyword3 = keyword3_entry.get() # Assigning the value of the variable "keyword3_entry" to "keyword 3"

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    file=open(product1,  "w") # Creating a new file with the file name as the value of the variable "product1"
    ...
    file.write(category1+"\n") # Writing the value of the variable "category1" (category) to the file
    ...
    price_entry.delete(0, END) # Deleting the value held in the price entry field

    
    screen9.destroy() # Deleting the sceren where the user had entered all the product information
    variable_1 = Label(screen6, text = "Product sucessfully listed", fg = "green", font = ("Calibri", 11)).pack()
     
    os.chdir(ORIGINAL_ROOT_DIR) # Changing the directory to the value of the variable "ORIGINAL_ROOT_DIR"
    ...
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_products"
    # Creating a new directory, which would be used to store all the product files
    # Assigning the value of this new directory to the variable "path_for_products"

    is_existing_products = os.path.exists(path_for_products) # Creating a boolean variable depending on whether the directory based on the value of the variable "path_for_products" exists
    if is_existing_products == True: # Creating a conditional statement based on the state of the variable "is_existing_products"
        # If true, it means that the product directory already exists, so there is no need to generate it
        print("Doing nothing")
    else:
        # If false, it means that the product directory does not exist, which means that it would have to be created
        print("Creating the new directory")
    ...
    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_books = ("Books") # Assigning the value "Books" to the variable "directory_for_books"
    path_for_books = os.path.join(cwd, directory_for_books)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_books"
    # Creating a new directory, which would be used to store all products which would be in the "book" category
    # Assigning the value of this new directory to the variable "path_for_books"
    print(path_for_books)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_games = ("Games") # Assigning the value "Games" to the variable "directory_for_games"
    path_for_games = os.path.join(cwd, directory_for_games)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_games"
    # Creating a new directory, which would be used to store all products which would be in the "Games" category
    # Assigning the value of this new directory to the variable "path_for_games"
    print(path_for_games)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_electronics = ("Electronics") # Assigning the value "Electronics" to the variable "directory_for_electronics"
    path_for_electronics = os.path.join(cwd, directory_for_electronics)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_electronics"
    # Creating a new directory, which would be used to store all products which would be in the "Electronics" category"
    # Assigning the value of this new directory to the variable "path_for_electronics"
    print(path_for_electronics)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_homegarden = ("Home") # Assigning the value "Home" to the variable "directory_for_homegarden"
    path_for_homegarden = os.path.join(cwd, directory_for_homegarden)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_homegarden"
    # Creating a new directory, which would be used to store all products which would be in the "Home & Garden" category
    # Assigning the value of this new directory to the variable "path_for_homegarden"
    print(path_for_homegarden)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_toys = ("Toys") # Assigning the value "Toys" to the variable "directory_for_toys"
    path_for_toys = os.path.join(cwd, directory_for_toys)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_toys"
    # Creating a new directory, which would be used to store all products which would be in the "Toys" category
    # Assigning the value of this new directory to the variable "path_for_toys"
    print(path_for_toys)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_clothesjewellery = ("Clothes") # Assigning the value "Clothes" to the variable "directory_for_clothesjewellery"
    path_for_clothesjewellery = os.path.join(cwd, directory_for_clothesjewellery)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_clothesjewellery"
    # Creating a new directory, which would be used to store all products which would be in the "Clothes & Jewellery" category
    # Assigning the value of this new directory to the variable "path_for_clothesjewellery"
    print(path_for_clothesjewellery)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_sportsoutdoors = ("Sports") # Assigning the value "Sports" to the variable "directory_for_sportsoutdoors"
    path_for_sportsoutdoors = os.path.join(cwd, directory_for_sportsoutdoors)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_sportsoutdoors"
    # Creating a new directory, which would be used to store all products which would be in the "Sports & Outdoors" category
    # Assigning the value of the new directory to the variable "path_for_sportsoutdoors"
    print(path_for_sportsoutdoors)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_food = ("Food") # Assigning the value "Food" to the variable "directory_for_food"
    path_for_food = os.path.join(cwd, directory_for_food)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_food"
    # Creating a new directory, which would be used to store all products which would be in the "Food" category
    # Assigning the value of the new directory to the variable "path_for_food"
    print(path_for_food)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_health = ("Health") # Assigning the value "Health" to the variable "directory_for_health"
    path_for_health = os.path.join(cwd, directory_for_health)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_health"
    # Creating a new directory, which would be used to store all products which would be in the "Health" category
    # Assigning the value of the new directory to the variable "path_for_health"

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_motorvehicles = ("MotorVehicles") # Assigning the value "MotorVehicles" to the variable "directory_for_motorvehicles"
    path_for_motorvehicles = os.path.join(cwd, directory_for_motorvehicles)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_motorvehicles"
    # Creating a new directory, which would be used to store all products which would be in the "Motor Vehicles" category
    # Assigning the value of the new directory to the variable "path_for_motorvehicles"
    print(path_for_motorvehicles)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigning the value of the current directory to the variable "cwd"
    directory_for_education = ("Education") # Assigning the value "Education" to the variable "directory_for_education"
    path_for_education = os.path.join(cwd, directory_for_education)
    # Through the os.path.join function, it concatenates the values of the variables "cwd" and "directory_for_education"
    # Creating a new directory, which would be used to store all products which would be in the "Education" category
    # Assigning the value of the new directory to the variable "path_for_education"
    print(path_for_education)
    is_existing_education = os.path.exists(path_for_education) # Creating a boolean variable depending on whether the directory based on the value of the variable "path_for_education" exists
    if is_existing_education == True: # Intialising a conditional statement based on the value of the variable "is_existing_education"
        # If true, it means that the education directory as well as all other directories would have already been created
        # This means that there is no need to generate new directories
        print("Doing nothing")
    else:
        # If "False", it means that the education directory as well as all other directories have yet to be created
        # This means that all the directories would have to be generated
        print("Creating the new directory")
        os.mkdir(path_for_games) # Making the directory with the value of the variable "path_for_games"
        os.mkdir(path_for_electronics) # Making the directory with the value of the variable "path_for_electronics"
        os.mkdir(path_for_homegarden) # Making the directory with the value of the variable "path_for_homegarden"
        os.mkdir(path_for_toys) # Making the directory with the value of the variable "path_for_toys"
        os.mkdir(path_for_clothesjewellery) # Making the directory with the value of the variable "path_for_clothesjewellery"
        os.mkdir(path_for_sportsoutdoors) # Making the directory with the value of the variable "path_for_sportsoutdoors"
        os.mkdir(path_for_food) # Making the directory with the value of the variable "path_for_food"
        os.mkdir(path_for_health) # Making the directory with the value of the variable "path_for_health"
        os.mkdir(path_for_motorvehicles) # Making the directory with the value of the variable "path_for_motorvehicles"
        os.mkdir(path_for_education) # Making the directory with the value of the variable "path_for_education"
        print("Made new directory")
...
def main_screen():
    global screen # Declaring the main screen
    global ORIGINAL_ROOT_DIR # Globalising the variable "ORIGINAL_ROOT_DIR"
    screen=Tk()
    ...
    ORIGINAL_ROOT_DIR = StringVar() # Declaring the variable "ORIGINAL_ROOT_DIR" as a string variable
    ORIGINAL_ROOT_DIR = os.getcwd() # Assigning the value of the current directory to the variable "ORIGINAL_ROOT_DIR"
    cwd = os.getcwd() # Assigning the value of the current directory to the variale "cwd"
    ...
    # Creating a new directory, which would be used to store all the user files
    # Assigning the value of this new directory to the variable "path_for_users"
    is_existing_users = os.path.exists(path_for_users) # Creating a boolean variable depending on whether the directory based on the value of the variable "path_for_users" exists

    if is_existing_users == True: #Creating a conditional statement based on the state of the variable "is_existing_users"
        # If true, it means that the user directory already exists, meaning there is no need to generate that directory
        print("Doing nothing")
    else:
        # If false, it means that the user directory does not exist, meaning it would need to be generated
        os.mkdir(path_for_users) # Making a directory with the value of the variable "path_for_users"
        print("Made new directory")
