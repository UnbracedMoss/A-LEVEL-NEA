...
def final_screen():
    ...
    if quantity == 0:
        ...
        if money_available > price: # Initialising a conditional statement based on whether the value of the variable "money_available" is greater than the value of the variable "price"
          # If the value of "money_available" is greater than "price", it means that the user should be able to purchase the product
            money_available = money_available - price # Subtracting the value of "price" from the value of "money_available", assigning the result to the variable "money_available"
            new_buyer_content = str(money_available) # Assigning the string value of the variable "money_available" to the variable "new_buyer_content"
            buyer_content[7] = (new_buyer_content) # Writing the value of the variable "new_buyer_content" to the 8th value within "buyer_content"
            seller_money = seller_money + price # Adding the value of the variables "seller_money" and "price", assigning the result to the variable "seller_money"
            new_seller_content= str(seller_money) # Assigning the string value of the variable "seller_money" to the variable "new_seller_content"
            seller_content[7] = (new_seller_content) # Writing the value of the variable "new_seller_content" as the 8th value of "seller_content"
            buyer_write = open(username1, "w") # Opening the file with the value of the variable "username1" as the file name, assigning the contents to the variable "buyer_write"
            buyer_write.writelines(buyer_content) # Writing the value of "buyer_content" (with the updated buyer money) to the open file
            seller_write = open(seller, "w") # Opening the file with the value of the variable "seller", assigning the contents to the variable "seller_write"
            seller_write.writelines(seller_content) # Writing the value of "seller_content" (with the updated seller money) to the open file

            print(quantity)
            q_data = StringVar() # Declaring the variable "q_data" as a string variable
            q_data = str(quantity) # Assigning the string value of "quantity" to the variable "q_data"
            content[2] = (q_data + "\n")# Writing the value of the variable "q_data" as the 3rd value of "content"
            print(content) 
            os.chdir(purchasing_directory) # Changing the directory to the value of the variable "purchasing_directory"
            quantity_write = open(purchasing_product, "w") # Opening the file with the value of the variable "purchasing_product", assigning the contents to the variable "quantity_write"
            quantity_write.writelines(content) # Writing the value of "content" to the open file
            lucky = Label(screen6, text = "Item purchased, delivery is who knows when")
            lucky.pack()
            screen.after(3000, lucky.destroy) # Destroying the item purchased message
            print(username1)
            os.chdir(path_for_users) # Changing the directory to the value of the variable "path_for_users"
            # Basically, I need to open the file with "a" as that is append, opening the file with "w" destroys everyting within the file
            z = open(username1, "a") # Opening the file with the value of the variable "username1" as the file name, assigning the contents to the variable "z"
            print(z)
            print(purchasing_product)
            z.write(purchasing_product + "\n") # Writing the value of the variable "purchasing_product" to the open file
        else:
            print("Man broke")
