...
def store_products():
    ...
    if not_number == True:
        ...
        if len(product1) == 0: # Initialising a conditional statement based on the length of the variable "product1"
          # If the length equals 0, it means the user has not entering the product name
            print("WORKS")
            screen9.destroy()
            no_product1_entry = Label(screen6, text = "Product name has not been entered, please enter again")
            no_product1_entry.pack() # Displaying to the user that they have not entered the required field
            screen.after(3000, no_product1_entry.destroy)
            return # Returning the user back to beginning, to restart the process of listing a product for sale
        
        if len(price1) == 0: # Initialising a conditional statement based on the value of the variable "price1"
          # If the length equals 0, it means the user has not entering the product price
            screen9.destroy()
            no_price1_entry = Label(screen6, text = "Price has not been entered, please enter all information again")
            no_price1_entry.pack() # Displaying to the user that they have not entered the required field
            screen.after(3000, no_price1_entry.destroy)
            return # Returning the user back to beginning, to restart the process of listing a product for sale
          
        if len(keyword1) == 0:
          # If the length equals 0, it means the user has not entering the 1st keyword for the product
            screen9.destroy()
            no_keyword_1_entry = Label(screen6, text = "Keyword 1 has not been entered, please enter all information again")
            no_keyword1_entry.pack() # Displaying to the user that they have not entered the required field
            screen.after(3000, no_keyword1_entry.destroy)
            return # Returning the user back to beginning, to restart the process of listing a product for sale
        
        if len(keyword2) == 0:
          # If the length equals 0, it means the user has not entering the 2nd keyword for the product
            screen9.destroy()
            no_keyword2_entry = Label(screen6, text = "Keyword 2 has not been entered, please enter all information again")
            no_keyword2_entry.pack() # Displaying to the user that they have not entered the required field
            screen.after(3000, no_keyword2_entry.destroy)
            return # Returning the user back to beginning, to restart the process of listing a product for sale
          
        if len(keyword3) == 0:
          # If the length equals 0, it means the user has not entering the 3rd keyword for the product
            screen9.destroy()
            no_keyword3_entry = Label(screen6, text = "Keyword 3 has not been entered, please enter all information again")
            no_keyword3_entry.pack() # Displaying to the user that they have not entered the required field
            screen.after(3000, no_keyword3_entry.destroy)
            return # Returning the user back to beginning, to restart the process of listing a product for sale
          
        if len(decription) == 0:
          # If the length equals 0, it means the user has not entering the product description
            screen9.destroy()
            no_description_entry = Label(screen6, text = "Nothing has been entered for description, please add more")
            no_description_entry.pack() # Displaying to the user that they have not entered the required field
