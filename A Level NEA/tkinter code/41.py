...
def book_select():
    ...
    Label(screen26, text = book_info[7]).pack()
...
def final_screen():
    ...
    Label(screen38, text = "Congratulations").pack()
...
def selling():
    ...
    quantity_entry = Entry(screen9) # Asking user for quantity, storing the user input in the variable "quantity_entry"
    quantity_entry.pack()
...
def store_products():
    ...
    product1 = StringVar() # Declaring the variable "product1" as a string variable
    price1 = StringVar() # Declaring the variable "price1" as a string variable
    quantity1 = StringVar() # Declaring the variable "quantity1" as a string variable
    category1 = StringVar() # Declaring the variable "category1" as a string variable
    keyword1 = StringVar() # Declaring the variable "keyword1" as a string variable
    keyword2 = StringVar() # Declaring the variable "keyword2" as a string variable
    keyword3 = StringVar() # Declaring the variable "keyword3" as a string variable
    description = StringVar() # Declaring the variable "description" as a string variable
    ...
    quantity1 = quantity_entry.get() # Assigning the value of the variable "quantity_entry" to the variable "quantity1"
    ...
    description = description_entry.get(1.0 , END) # Assigning the value of the variable "description_entry" to the variable "description"

    price_not_number = BooleanVar() # Declaring the variable "price_not_number" as a boolean variable
    price_not_number = False # Assigning the value "False" to the variable "price_not_number"

    quantity_not_number = BooleanVar() # Declaring the variable "quantity_not_number" as a boolean variable
    quantity_not_number = False # Assigning the value "False" to the variable "quantity_not_number"

    not_number = BooleanVar() # Declaring the variable "not_number" as a boolean variable
    not_number = False # Assigning the value "False" to the variable "not_number"
    
    x = price_entry.get() # Assigning the value of the variable "price_entry" to the variable "x"
    try:
        int(x) # Getting the integer value of the variable "x"
    except ValueError:
      # If an error is generated it means that an integer value was not entered for product price
        price_not_number = True
      # Assigning the value "True" to the variable "price_not_number"
        print(price_not_number)

    y = quantity_entry.get() # Assigning the value of the variable "quantity_entry" to the variable "y"
    try:
        int(y) # Getting the integer value of the variable "y"
    except ValueError:
      # If an error is generated it means that an integer value was not entered for quantity
        quantity_not_number = True
      # Assigning the value "True" to the variable "quantity_not_number"
        print(quantity_not_number)


    if (quantity_not_number == True) or (price_not_number == True): # Initialising a conditional statement based on the value of the variables "quantity_not_number" and "price_not_number"
      # If "quantity_not_number" equals True, it means that an integer value was not entered for the product quantity
      # If "price_not_number" equals True, it means that an integer value was not entered for the product price
        not_number = True # Assigning the value "True" to the variable "not_number"
        print(not_number)
    else:
      # Means that both the product price and the product quantity had integer inputs
        not_number = False # Assigning the value "False" to the variable "not_number"
        print(not_number)
    ...
    if not_number == False: # Initalising a conditional statement based on the value of the variable "not_number"
      # If the value equals False, it means that an integer value was entered for both price and quantity
        if forgotten_password_used == True: # Initialising a conditional statement based on the value of the variable "forgotten_password_used"
        ...
        if category1 == "Books": # Initialising a conditional statement based on the value of the variable "category1"
          # If the value equals Books, it means that a product within the book category is being listed for sale
          # Which means that the product information needs to be stored within the book directory
            print(path_for_books)
          ...
          # If the value equals Games, it means that a product within the games category is being listed for sale
          # Which means that the product information needs to be stored within the games directory
            os.chdir(path_for_games) # Changing the directory to the value of the varibale "path_for_games" (Games directory)
        elif category1 == "Electronics":
          # If the value equals Electronics, it means that a product within the electronics category is being listed for sale
          # Which means that the product information needs to be stored within the electronics directory
          ...
          # If the value equals "Home & Garden", it means that a product within the 
            os.chdir(path_for_homegarden)
        elif category1 == "Toys":
            os.chdir(path_for_toys)
