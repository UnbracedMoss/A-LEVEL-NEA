...
def books():
    global screen15 # Defining a new screen
    global book_list # Globalising the variable "book_list"
    global book_entry # Globalising the variable "book_entry"
    global book_list_data # Globalising the variable "book_list_data"
    global path_for_books # Globalising the variable "path_for_books" (Book directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 1 # Assigning the value "1" to the variable "purchasing_choice" (Indicating a book product has been selected)
    screen15 = Toplevel(screen) # Making this screen appear at the top
    screen15.title("Books") # Defining the header of the screen
    screen15.geometry("500x500") # Defining the dimensions of the screen
...
def games():
    global screen16 # Defining a new screen
    global game_list # Globalising the variable "game_list"
    global game_entry # Globalising the variable "game_entry"
    global game_list_data # Globalising the variable "game_list_data"
    global path_for_games # Globalising the variable "path_for_games" (Games directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 2 # Assigning the value "2" to the variable "purchasing_choice" (Indicating a games product has been selected)
    screen16 = Toplevel(screen) # Making this screen appear at the top
    screen16.title("Games") # Defining the header of the screen
    screen16.geometry("500x500") # Defining the dimensions of the screen
...
def electronics():
    global screen17 # Defining a new screen
    global electronics_list # Globalising the variable "electronics_list"
    global electronics_entry # Globalising the variable "electronics_entry"
    global electronics_list_data # Globalising the variable "electronics_list_data"
    global path_for_electronics # Globalising the variable "path_for_electronics" (Electronics directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 3 # Assigning the value "3" to the variable "purchasing_choice" (Indicating an electronics product has been selected)
    screen17 = Toplevel(screen) # Making this screen appear at the top
    screen17.title("Electronics") # Defining the header of this screen
    screen17.geometry("500x500") # Defning the dimensions of the screen.
...
def home_garden():
    global screen18 # Defining a new screen
    global home_garden_list # Globalising the variable "home_garden_list"
    global home_garden_entry # Globalising the variable "home_garden_entry"
    global home_garden_list_data # Globalising the variable "home_garden_list_data"
    global path_for_homegarden # Globalising the variable "path_for_homegarden" (Home & Garden directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 4 # Assigning the value "4" to the variable "purchasing_choice" (Indicating a Home & Garden product has been selected)
    screen18 = Toplevel(screen) # Making this screen appear at the top
    screen18.title("Home & Garden") # Defining the header of the screen
    screen18.geometry("500x500") # Defining the dimensions of the screen
...
def toys():
    global screen19 # Defining a new screen
    global toys_list # Globalising the variable "toys_list"
    global toys_entry # Globalising the variable "toys_entry"
    global toys_list_data # Globalising the variable "toys_list_data"
    global path_for_toys # Globalising the variable "path_for_toys" (Toys directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 5 # Assigning the value "5" to the variable "purchasing_choice" (Indicating a toy product has been selected)
    screen19 = Toplevel(screen) # Making this screen appear at the top
    screen19.title("Toys") # Defining the header of this screen
    screen19.geometry("500x500") # Defining the dimensions of this screen
...
def clothes_jewellery():
    global screen20 # Defining a new screen
    global clothes_jewellery_list # Globalising the variable "clothes_jewellery_list"
    global clothes_jewellery_entry # Globalising the variable "clothes_jewellery_entry"
    global clothes_jewellery_list_data # Globalising the variable "clothes_jewellery_list_data"
    global path_for_clothesjewellery # Globalising the variable "path_for_clothesjewellery" (Clothes & Jewellery directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 6 # Assigning the value "6" to the variable "purchasing_choice" (Indicating a clothes & jewellery product has been selected)
    screen20 = Toplevel(screen) # Making this screen appear at the top
    screen20.title("Clothes & Jewellery") # Defining the header of this screen
    screen20.geometry("500x500") # Defining the dimensions of this screen
...
def sports_outdoors():
    global screen21 # Defining a new screen
    global sports_outdoors_list # Globalising the variable "sports_outdoors_list"
    global sports_outdoors_entry # Globalising the variable "sports_outdoors_entry"
    global sports_outdoors_list_data # Globalising the variable "sports_outdoors_list_data"
    global path_for_sportsoutdoors # Globalising the variable "path_for_sportsoutdoors" (Sports & Outdoors directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 7 # Assigning the value "7" to the variable "purchasing_choice" (Indicating that a sports & outdoors product is selected)
    screen21 = Toplevel(screen) # Making this screen appear at the top
    screen21.title("Sports & Outdoors") # Defining the title of the screen
    screen21.geometry("500x500") # Defining the dimensions of the screen
...
def food():
    global screen22 # Defining a new screen
    global food_list # Globalising the variable "food_list"
    global food_entry # Globalising the variable "food_entry"
    global food_list_data # Globalising the variable "food_list_data"
    global path_for_food # Globalising the variable "path_for_food" (Food directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 8 # Assigning the value "8" to the variable "purchasing_choice" (Indicating a food product has been selected)
    screen22 = Toplevel(screen) # Making this screen appear at the top
    screen22.title("Food") # Defining the title of the screen
    screen22.geometry("500x500") # Defining the dimensions of the screen
...
def health():
    global screen23 # Defining a new screen
    global health_list # Globalising the variable "health_list"
    global health_entry # Globalising the variable "health_entry"
    global health_list_data # Globalising the variable "health_list_data"
    global path_for_health # Globalising the variable "path_for_health" (Health directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 9 # Assigning the value "9" to the variable "purchasing_choice" (Indicating a health product has been selected)
    screen23 = Toplevel(screen) # Making this screen appear at the top
    screen23.title("Health") # Defining the title of the screen
    screen23.geometry("500x500") # Defining the dimensions of the screen
...
def motor_vehicles():
    global screen24 # Defining a new screen
    global motor_vehicles_list # Globalising the variable "motor_vehicles_list"
    global motor_vehicles_entry # Globalising the variable "motor_vehicles_entry"
    global motor_vehicles_list_data # Globalising the variable "motor_vehicles_list_data"
    global path_for_motorvehicles # Globalising the variable "path_for_motorvehicles" (Motor vehicles directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 10 # Assigning the value "10" to the variable "purchasing_choice" (Indicating a motor vehicle has been selected)
    screen24 = Toplevel(screen) # Making this screen appear at the top
    screen24.title("Motor Vehicles") # Defining the title of the screen
    screen24.geometry("500x500") # Defining the dimensions of the screen
...
def education():
    global screen25 # Defining a new screen
    global education_list # Globalising the variable "education_list"
    global education_entry # Globalising the variable "education_entry"
    global education_list_data # Globalising the variable "education_list_data"
    global path_for_education # Globalising the variable "path_for_education" (Education directory)
    global purchasing_choice # Globalising the variable "purchasing_choice"
    purchasing_choice = 11 # Assigning the value "11" to the variable "purchasing_choice" (Indicating an education product has been selected)
    screen25 = Toplevel(screen) # Making this screen appear at the top
    screen25.title("Education") # Defining the title of the screen
    screen25.geometry("500x500") # Defining the dimensions of the screen
...
def selection_screen():
    global screen51 # Defining a new screen    
    global ORIGINAL_ROOT_DIR # Globalising the variable "ORIGINAL_ROOT_DIR"
    global selected_directory # Globalising the variable "selected_directory"
    global purchasing_choice # Globalising the variable "purchasing_choice"
    global selected_product # Globalising the variable "selected_product"
    global selected_book # Globalising the variable "selected_book"
    global selected_game # Globalising the variable "selected_game"
    global selected_electronic # Globalising the variable "selected_electronic"
    global selected_home_garden # Globalising the variable "selected_home_garden"
    global selected_toys # Globalising the variable "selected_toys"
    global selected_clothes_jewellery # Globalising the variable "selected_clothes_jewellery"
    global selected_sports_outdoors # Globalising the variable "selected_sports_outdoors"
    global selected_food # Globalising the variable "selected_food"
    global selected_health # Globalising the variable "selected_health"
    global selected_motor_vehicles # Globalising the variable "selected_motor_vehicles"
    global selected_education # Globalising the variable "selected_education"
    global education_entry # Globalising the variable "education_entry"
    global path_for_products # Globalising the variable "path_for_products" (products directory)
    global path_for_books # Globalising the variable "path_for_books" (books directory)
    global path_for_games # Globalising the variable "path_for_games" (games directory)
    global path_for_electronics # Globalising the variable "path_for_electronics" (electronics directory)
    global path_for_homegarden # Globalising the variable "path_for_homegarden" (home & garden directory)
    global path_for_toys # Globalising the variable "path_for_toys" (toys directory)
    ...
    global path_for_motorvehicles # Globalising the variable "path_for_motorvehicles" (motor vehicles directory)
    global path_for_education # Globalising the variable "path_for_education" (education directory)
    global user_dir # Globalising the variable "user_dir" (user directory)

    selected_product = StringVar() # Declaring the variable "selected_product" as a string variable

    if purchasing_choice == 1: # Initialising a conditional statement based on the value of the variable "purchasing_choice"
      # If the value of "purchasing_choice" equals 1, it means that a book product has been selected
        selected_book = book_entry.get() # Assigning the value of the variable "book_entry" to the variable "selected_book"
        selected_product = selected_book # Assigning the value of the variable "selected_book" to the variable "selected_product"
        selected_directory = path_for_books # Assigning the value of the variable "path_for_books" to the variable "selected_directory"
    elif purchasing_choice == 2:
      # If the value of "purchasing_choice" equals 2, it means that a games product has been selected
        selected_game = game_entry.get() # Assigning the value of the variable "game_entry" to the variable "selected_game"
        selected_product = selected_game # Assigning the value of the variable "selected_game" to the variable "selected_product"
        selected_directory = path_for_games # Assigning the value of the variable "path_for_games" to the variable "selected_directory"
    elif purchasing_choice == 3:
      # If the value of "purchasing_choice" equals 3, it means that an electronics product has been selected
        selected_electronic = electronics_entry.get() # Assigning the value of the variable "electronics_entry" to the variable "selected_electronic"
        selected_product = selected_electronic # Assigning the value of the variable "selected_electronic" to the variable "selected_product"
        selected_directory = path_for_electronics # Assigning the value of the variable "path_for_electronics" to the variable "selected_directory"
    elif purchasing_choice == 4:
      # If the value of "purchasing_choice" equals 4, it means that a home & garden product has been selected
        selected_home_garden = home_garden_entry.get() # Assigning the value of the variable "home_garden_entry" to the variable "selected_home_garden"
        selected_product = selected_home_garden # Assigning the value of the variable "selected_home_garden" to the variable "selected_product"
        selected_directory = path_for_homegarden # Assigning the value of the variable "path_for_homegarden" to the variable "selected_directory"
    elif purchasing_choice == 5:
      # If the value of "purchasing_choice" equals 5, it means that a toy product has been selected
        selected_toys = toys_entry.get() # Assigning the value of the variable "toys_entry" to the variable "selected_toys"
        selected_product = selected_toys # Assigning the value of the variable "selected_toys" to the variable "selected_product"
        selected_directory = path_for_toys # Assigning the value of the variable "path_for_toys" to the variable "selected_directory"
    elif purchasing_choice == 6:
      # If the value of "purchasing_choice" equals 6, it means that a clothes & jewellery product has been selected
        selected_clothes_jewellery = clothes_jewellery_entry.get() # Assigning the value of the variable "clothes_jewellery_entry" to the variable "selected_clothes_jewellery"
        selected_product = selected_clothes_jewellery # Assigning the value of the variable "selected_clothes_jewellery" to the variable "selected_product"
        selected_directory = path_for_clothesjewellery # Assigning the value of the variable "path_for_clothesjewellery" to the variable "selected_directory"
    elif purchasing_choice == 7:
      # If the value of "purchasing_choice" equals 7, it means that a sports & outdoors product has been selected
        selected_sports_outdoors = sports_outdoors_entry.get() # Assigning the value of the variable "sports_outdoors_entry" to the variable "selected_sports_outdoors"
        selected_product = selected_sports_outdoors # Assigning the value of the variable "selected_sports_outdoors" to the variable "selected_product"
        selected_directory = path_for_sportsoutdoors # Assigning the value of the variable "path_for_sportsoutdoors" to the variable "selected_directory"
    elif purchasing_choice == 8:
      # If the value of "purchasing_choice" equals 8, it means that a food product has been selected
        selected_food = food_entry.get() # Assigning the value of the variable "food_entry" to the variable "selected_food"
        selected_product = selected_food # Assigning the value of the variable "selected_food" to the variable "selected_product"
        selected_directory = path_for_food # Assigning the value of the variable "path_for_food" to the variable "selected_directory"
    elif purchasing_choice == 9:
      # If the value of "purchasing_choice" equals 9, it means that a health product has been selected
        selected_health = health_entry.get() # Assigning the value of the variable "health_entry" to the variable "selected_health"
        selected_product = selected_health # Assigning the value of the variable "selected_health" to the variable "selected_product"
        selected_directory = path_for_health # Assigning the value of the variable "path_for_health" to the variable "selected_directory"
    elif purchasing_choice == 10:
      # If the value of "purchasing_choice" equals 10, it means that a motor vehicle has been selected
        selected_motor_vehicles = motor_vehicles_entry.get() # Assigning the value of the variable "motor_vehicles_entry" to the variable "selected_motor_vehicles"
        selected_product = selected_motor_vehicles # Assigning the value of the variable "selected_motor_vehicles" to the variable "selected_product"
        selected_directory = path_for_motorvehicles # Assigning the value of the variable "path_for_motorvehicles" to the variable "selected_directory"
    elif purchasing_choice == 11:
      # If the value of "purchasing_choice" equals 11, it means that an education product has been selected
        selected_education = education_entry.get() # Assigning the value of the variable "education_entry" to the variable "selected_education"
        selected_product = selected_education # Assigning the value of the variable "selected_education" to the variable "selected_product"
        selected_directory = path_for_education # Assigning the value of the variable "path_for_education" to the variable "selected_directory"
    else:
        print("Maybe issue")
    print(selected_product)
    print(selected_directory)
    screen37 = Toplevel(screen) # Making this screen appear at the top
    screen37.title("Purchasing Screen") # Defining the header of the screen
    screen37.geometry("500x500") # Defining the dimensions of the screen
