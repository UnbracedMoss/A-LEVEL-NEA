...
def book_select():
    global screen26 # Defining a new screen
    ...
    global book_info # Globalising the variable "book_info"
    selected_book = book_entry.get() # Assigning the value of the variable "book_entry" to the variable "selected_book"
    screen26 = Toplevel(screen) # Making this screen appear at the top
    screen26.title(selected_book) # Defining the header of this screen
    screen26.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_books) # Changing the directory to the value of the variable "path_for_books" (book directory)
    

    f= open(selected_book) # Opening the file under the name of the value of the variable "selected_book" and assigning its content to "f"
    book_info = f.readlines() # Separating the contents of the files & removing the newline comments, then assigning its content to "book_info"
    print(book_info)

    Label(screen26, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen26, text = book_info[0]).pack() # Displaying to the user the product name of the product they had selected

    Label(screen26, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen26, text = book_info[1]).pack() # Displaying to the user the price of the product they had selected

    Label(screen26, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen26, text = book_info[5]).pack() # Displaying to the user the description of the product they had selected

    Label(screen26, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen26, text = book_info[2]).pack() # Displaying to the user the seller information of the product they had selected
...
def game_select():
    global screen27 # Defining a new screen
    global selected_game # Globalising the variable "selected_game"
    global ORIGINAL_ROOT_DIR # Globalising the variable "ORIGINAL_ROOT_DIR"
    global path_for_games # Globalising the variable "path_for_games"
    global game_info # Globalising the variable "games_info"
    selected_game = game_entry.get() # Assigning the value of the variable "game_entry" to the variable "selected_game"
    print(selected_game)
    screen27 = Toplevel(screen) # Making this screen appear at the top
    screen27.title(selected_game) # Defining the header of this screen
    screen27.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_games) # Changing the directory to the value of the variable "path_for_games" (games directory)
    

    f= open(selected_game) # Opening the file with the name as the value of the variable "selected_game" and assigning its content to "f"
    game_info = f.readlines() # Separating the contents into lines & removing the newline comments, then assigning its contents to "game_info"
    print(game_info)

    Label(screen27, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen27, text = game_info[0]).pack() # Displaying the name of the product that the user had selected

    Label(screen27, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen27, text = game_info[1]).pack() # Displaying the price of the product that the user had selected

    Label(screen27, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen27, text = game_info[5]).pack() # Displaying the description of the product that the user had selected

    Label(screen27, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen27, text = game_info[2]).pack() # Displaying the seller information of the product that the user had selected
...
def electronics_select():
    global screen28 # Defining a new screen
    ...
    global electronic_info # Globalising the variable "electronic_info"
    ...
    screen28 = Toplevel(screen) # Making this screen appear at the top
    screen28.title(selected_electronic) # Defining the header of this screen
    screen28.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_electronics) # Changing the directory to the value of the variable "path_for_electronics" (electronics directory)
    

    f= open(selected_electronic) # Opening the file under the name of the value of the variable "selected_electronic" and assigning its content to "f"
    electronic_info = f.readlines() # Separating the contents & removing the newline comments, then assigning the contents of "f" to "electronic_info"
    print(electronic_info)

    Label(screen28, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen28, text = electronic_info[0]).pack() # Displaying the name of the product that the user had selected

    Label(screen28, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen28, text = electronic_info[1]).pack() # Displaying the price of the product that the user had selected

    Label(screen28, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen28, text = electronic_info[8]).pack() # Displaying the description of the product that the user had selected

    Label(screen28, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen28, text = electronic_info[2]).pack() # Displaying the seller information of the product that the user had selected
...
def home_garden_select():
    global screen29 # Defining a new screen
    ...
    global home_garden_info # Globalising the variable "home_garden_info"
    selected_home_garden = home_garden_entry.get() # Assigning the value of the variable "home_garden_entry" to "selected_home_garden"
    print(selected_home_garden)
    screen29 = Toplevel(screen) # Making this screen appear at the top
    screen29.title(selected_home_garden) # Defining the header of this screen
    screen29.geometry("500x500") # Defining the dimensions of this screen
    ...
    f= open(selected_home_garden) # Opening the file with the name as the value of the variable "selected_home_garden" and assigning its content to "f"
    home_garden_info = f.readlines() # Separating the content & removing the newline comments of the contents of "f" and assigning it to "home_garden_info"
    print(home_garden_info)

    Label(screen29, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen29, text = home_garden_info[0]).pack() # Displaying the name of the product that the user had selected

    Label(screen29, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen29, text = home_garden_info[1]).pack() # Displaying the price of the product that the user had selected 

    Label(screen29, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen29, text = home_garden_info[8]).pack() # Displaying the description of the product that the user had selected

    Label(screen29, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen29, text = home_garden_info[2]).pack() # Displaying the seller information of the product that the user had selected
...
def toys_select():
    global screen30 # Defining a new screen
    global selected_toys # Globalising the variable "selected_toys"
    global ORIGINAL_ROOT_DIR # Globalising the variable "ORIGNAL_ROOT_DIR"
    global path_for_toys # Globalising the variable "path_for_toys"
    global toys_info # Globalising the variable "toys_info"
    selected_toys = toys_entry.get() # Assigning the value of the variable "toys_entry" to the variable "selected_toys"
    print(selected_toys)
    screen30 = Toplevel(screen) # Making this screen appear at the top
    screen30.title(selected_toys) # Defining the header of this screen
    screen30.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_toys) # Changing the directory to the value of the variable "path_fopr_toys"
    

    f= open(selected_toys) # Opening the file under the name of the value of the variable "selected_toys" and assigning its content to "f"
    toys_info = f.readlines() # Separating the contents & removing the newline comments, then assigning its contents to "toys_info"
    print(toys_info)

    Label(screen30, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen30, text = toys_info[0]).pack() # Displaying the name of the product that the user had selected

    Label(screen30, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen30, text = toys_info[1]).pack() # Displaying the price of the product that the user had selected

    Label(screen30, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen30, text = toys_info[8]).pack() # Displaying the description of the product that the user had selected

    Label(screen30, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen30, text = toys_info[2]).pack() # Displaying the seller information of the product that the user had selected
...
def clothes_jewellery_select():
    global screen31 # Defining a new screen
    global selected_clothes_jewellery # Globalising the variable "selected_clothes_jewellery"
    global ORIGINAL_ROOT_DIR # Globalising the variable "ORIGNAL_ROOT_DIR"
    global path_for_clothesjewellery # Globalising the variable "path_for_clothesjewllery"
    global clothes_jewellery_info # Globalising the variable "clothes_jewellery_info"
    selected_clothes_jewellery = clothes_jewellery_entry.get() # Assigning the value of the variable "clothes_jewellery_entry" to "selected_clothes_jewellery"
    print(selected_clothes_jewellery)
    screen31 = Toplevel(screen) # Making this screen appear at the top
    screen31.title(selected_clothes_jewellery) # Defining the header of this screen
    screen31.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_clothesjewellery) # Changing the directory to the value of the variable "path_for_clothesjewllery"
    

    f= open(selected_clothes_jewellery) # Opening the file with the filename as the value of the variable "selected_clothes_jewellery" and assigning its contents to "f"
    clothes_jewellery_info = f.readlines() # Separating the content into lines & removing newline comments, then assigning the contents to "clothes_jewellery info"
    print(clothes_jewellery_info)

    Label(screen31, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen31, text = clothes_jewellery_info[0]).pack() # Displaying the name of the product the user selected

    Label(screen31, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen31, text = clothes_jewellery_info[1]).pack() # Displaying the price of the product the user seleced

    Label(screen31, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen31, text = clothes_jewellery_info[8]).pack() # Displaying the description of the product the user selected

    Label(screen31, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen31, text = clothes_jewellery_info[2]).pack() # Displaying the seller information of the product the user selected
...
def sports_outdoors_select():
    global screen32 # Defining a new screen
    ...
    global sports_outdoors_info # Globalising the variable "sports_outdooors_info"
    selected_sports_outdoors = sports_outdoors_entry.get() # Assigning the value of the variable "sports_outdoors_entry" to "selected_sports_outdoors"
    print(selected_sports_outdoors)
    screen32 = Toplevel(screen) # Making this screen appear at the top
    screen32.title(selected_sports_outdoors) # Defining the header of this screen
    screen32.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_sportsoutdoors) # Changing the directory to the value of the variable "path_for_sportsoutdoors"
    

    f= open(selected_sports_outdoors) # Opening the file with the name as the value of the variable "selected_sports_outdoors" and assigning the contents to "f"
    sports_outdoors_info = f.readlines() # Separating the file into lines & removing the newline comments, then assigning its contents to "sports_outdoors_info"
    print(sports_outdoors_info)

    Label(screen32, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen32, text = sports_outdoors_info[0]).pack() # Displaying the name of the product the user selected

    Label(screen32, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen32, text = sports_outdoors_info[1]).pack() # Displaying the price of the product the user selected

    Label(screen32, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen32, text = sports_outdoors_info[8]).pack() # Displaying the description of the product the user selected

    Label(screen32, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen32, text = sports_outdoors_info[2]).pack() # Displaying the seller information of the product the user selected
...
def food_select():
    global screen33 # Declaring a new screen
    global selected_food # Globalising tyhe variable "selected_food"
    global ORIGINAL_ROOT_DIR # Globalising the variable "ORIGINAL_ROOT_DIR"
    global path_for_food # Globalising the variable "path_for_food"
    global food_info # Globalising the variable "food_info"
    selected_food = food_entry.get() # Assigning the value of the variable "food_entry" to the variable "selected_food"
    print(selected_food)
    screen33 = Toplevel(screen) # Making this screen appear at the top
    screen33.title(selected_food) # Defining the header of this screen
    screen33.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_food) # Changing the directory to the value of the variable "path_for_food" (food directory)
    

    f= open(selected_food) # Opening the file with the name as the value of the variable "selected_food" and assigning its contents to "f"
    food_info = f.readlines() # Separating the contents of "f" & removing the newline comments, then assigning the contents to "food_info"
    print(food_info)

    Label(screen33, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen33, text = food_info[0]).pack() # Displaying the name of the product that the user selected

    Label(screen33, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen33, text = food_info[1]).pack() # Displaying the price of the product that the user selected

    Label(screen33, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen33, text = food_info[8]).pack() # Displaying the description of the product that the user selected

    Label(screen33, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen33, text = food_info[2]).pack() # Displaying the seller information of the product that the user selected
...
def health_select():
    global screen34 # Declaring a new screen
    ...
    global health_info # Globalsing the variable "health_info"
    selected_health = health_entry.get() # Assigning the value of "health_entry" to the variable "selected_health"
    print(selected_health)
    screen34 = Toplevel(screen) # Making this screen appear at the top
    screen34.title(selected_health) # Defining the header of this screen
    screen34.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_health) # Changing the directory to the value of the variable "path_for_health" (health directory)
    

    f= open(selected_health) # Opening the file with the name as the value of the variable "selected_health", assigning its contents to "f"
    health_info = f.readlines() # Separating the contents of "f" & removing the newline comments, then assigning the contents to "health_info"
    print(health_info)

    Label(screen34, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen34, text = health_info[0]).pack() # Displaying the name of the product the user selected

    Label(screen34, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen34, text = health_info[1]).pack() # Displaying the price of the product the user selected

    Label(screen34, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen34, text = health_info[8]).pack() # Displaying the description of the product the user selected

    Label(screen34, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen34, text = health_info[2]).pack() # Displaying the seller information of the product the user selected
...
def motor_vehicles_select():
    global screen35 # Declaring a new screen
    ...
    global motor_vehicles_info # Globalising the variable "motor_vehicles_info"
    selected_motor_vehicles = motor_vehicles_entry.get() # Assigning the value of "motor_vehicles_entry" to the variable "selected_motor_vehicles"
    print(selected_motor_vehicles)
    screen35 = Toplevel(screen) # Making this screen appear at the top
    screen35.title(selected_motor_vehicles) # Defining the header of this screen
    screen35.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_motorvehicles) # Changing the directory to the value of the variable "path_for_motorvehicles"
    

    f= open(selected_motor_vehicles) # Opening the file with the name as the value of the variable "selected_motor_vehicles", asssigning its contents to "f"
    motor_vehicles_info = f.readlines() # Separating the contents of "f" & removing newline comments, then assigning the contents to "motor_vehicles_info"
    print(motor_vehicles_info)

    Label(screen35, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen35, text = motor_vehicles_info[0]).pack() # Displaying the name of the product the user selected

    Label(screen35, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen35, text = motor_vehicles_info[1]).pack() # Displaying the price of the product the user selected

    Label(screen35, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen35, text = motor_vehicles_info[8]).pack() # Displaying the description of the product the user selected

    Label(screen35, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen35, text = motor_vehicles_info[2]).pack() # Displaying the seller information of the product the user selected
...
def education_select():
    global screen36 # Declaring a new screen
    ...
    global education_info # Globalising the variable "education_info"
    selected_education = education_entry.get() # Assigning the value of "education_entry" to the variable "selected_education"
    print(selected_education)
    screen36 = Toplevel(screen) # Making this screen appear at the top
    screen36.title(selected_education) # Defining the header of this screen
    screen36.geometry("500x500") # Defining the dimensions of this screen

    os.chdir(path_for_education) # Changing the directory to the value of the variable "path_for_education" (education directory)
    

    f= open(selected_education) # Opening the file with the name as the value of the variable "selected_education", assigning the contents to "f"
    education_info = f.readlines() # Separating the contents of "f" & removing the newline comments, assigning the contntets to "education_info"
    print(education_info)

    Label(screen36, text = "Product name:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen36, text = education_info[0]).pack() # Displaying the name of the product the user selected

    Label(screen36, text = "Price:", font=('Helvetica', 13, 'bold')).pack()
    Label(screen36, text = education_info[1]).pack() # Displaying the price of the product the user selected

    Label(screen36, text = "Description;", font=("Helvetica", 13, "bold")).pack()
    Label(screen36, text = education_info[8]).pack() # Displaying the description of the proudct tbe user selected

    Label(screen36, text = "Sold by:", font=("Helvetica", 13, "bold")).pack()
    Label(screen36, text = education_info[2]).pack() # Displaying the seller information of the product the user selected
