...
def update_book(book_list_data):
    ...
    #Clear the listbox
    book_list.delete(0, END) # Deleting the value held in the book list box
...
def check(event):
    ...
    typed_book = book_entry.get() # Assigning the value of the variable "book_entry" to the variable "typed_book"
...
def books():
    global screen15 # Declaring a new screen
    global book_list # Globalising the variable "book_list"
    global book_entry # Globalising the variable "book_entry"
    global book_list_data # Globalising the variable "book_list_data"
    ...
    # This is test data. Shall be tested after this works
