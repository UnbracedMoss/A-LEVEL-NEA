...
def selling():
    global screen9 # Declaring a new screen
    global product_entry # Globalising the variable "product_entry"
    global price_entry # Globalising the variable "price_entry"
    global clicked # Globalising the variable "clicked"
    global keyword1_entry # Globalising the variable "keyword1_entry"
    global keyword2_entry # Globalising the variable "keyword2_entry"
    global keyword3_entry # Globalising the variable "keyword3_entry"
    #new code-------------------------------------------------------------
    global str_out # Globalising the variable "str_out"
    global options # Globalising the variable "options"
    #new code ends-------------------------------------------------------
    screen9 = Toplevel(screen) # Making this screen appear at the top
    screen9.title("Generate a post") # Defining the header of this screen
    screen9.geometry("500x500") # Defining the dimensions of this screen
    product_entry = StringVar() # Declaring the variable "product_entry" as a string
    price_entry = IntVar() # Declaring the variable "price_entry" as an integer
    Label(screen9, text = "Product name*").pack()
    product_entry = Entry(screen9) # Taking the user input for product name and storing it in "product_entry"
    product_entry.pack()
    Label(screen9, text = "").pack()
    Label(screen9, text = "Price * ").pack()
    price_entry = Entry(screen9) # Taking the user input for product price and storing it in "price_entry"
    price_entry.pack()
    Label(screen9, text = "").pack()
    Label(screen9, text = "Keyword 1:").pack()
    keyword1_entry = Entry(screen9) # Taking the user input for the first keyword and storing it in "keyword1_entry"
    keyword1_entry.pack()
    Label(screen9, text = "").pack()
    Label(screen9, text = "Keyword 2:").pack()
    keyword2_entry = Entry(screen9) # Taking the user input for the second keyword and storing it in "keyword2_entry"
    keyword2_entry.pack()
    Label(screen9, text = "").pack()
    Label(screen9, text = "Keyword 3:").pack()
    keyword3_entry = Entry(screen9) # Taking the user input for the third keyword and storing it in "keyword3_entry"
    keyword3_entry.pack()
    options = [
        "Books" ,
        "Games" ,
    ...
    # Creating an array called "Options" that would hold all the different types of categories
    clicked = StringVar() # Declaring the variable "clicked" as a string
    clicked.set(options[0]) # Setting the default value of clicked as the first item in the "options" array ("Books")
    #new code--------------------------------------------------------------------------------------
    str_out = StringVar() # Declaring the variable "str_out" as a string
    str_out.set("Output") # Setting the value of "str_out" as "Output"
    drop = OptionMenu(screen9, clicked, *options) # Displaying to the user a drop down menu showcasing all the values held in "options"
     # Assign to the variable "clicked", the value that was selected by the user
    drop.pack(pady=20)
    b1 = Button(screen9, text = "Select category", command=lambda: my_show()) # Button to confirm the user choice, directing the code to the function my_show()
    b1.pack()
    Label(screen9, textvariable=str_out).pack() # Displaying to the user the value of the variable "str_out"
    #new code ends--------------------------------------------------------------------------------------------
    Label(screen9, text = "").pack()
    Label(screen9, text = "").pack()
...
#new code-----------------------------------------------------------------------------
def my_show():
    str_out.set(clicked.get()) # Set the value of "str_out" to the value of "clicked"
#new code ends---------------------------------------------------------
