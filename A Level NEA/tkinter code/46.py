...
def final_screen():
    ...
    if quantity == 0: # Initialising a conditional statement based on the value of the variable "quantity"
      # If the value of "quantity" equals 0, it means that there is no product to purchase
      # Meaning that the user should not be able to purchase the product
        print("No quantity to purchase")
        session() # Redirecting the user back to the main session
    
    else:
      # If the value of "quantity" does not equal 0, it means that there is a product available to purchase
      # Meaning that the user should be able to purchase the product
        quantity = quantity - 1 # Decreasing the value of the variable "quantity" by 1
        print(quantity)
        ...
        content[2] = (q_data + "\n") # Assigning the value of the variable "q_data" to the third value with the data structure "content"
        ...
        quantity_write.writelines(content) # Writing the values within the data structure "content" to the file assigned under "quantity_write"
        ...
        q = open(username1, "w") # Opening the file with the value of the variable "username1" (username of buyer), assigning the contents to the variable "q"
        print(q)
        q.write(purchasing_product + "\n") # Writing the value of the variable "purchasing_product" to the file
        q.close() # Closing the file so that no more changes can be made to it.
