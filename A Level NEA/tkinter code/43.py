...
def selection_screen():
    ...
    screen51 = Toplevel(screen) # Making this screen appear at the top
    screen51.title(selected_product) # Defining the header of the screen
    screen51.geometry("800x900") # Defining the dimensions of the screen
    os.chdir(selected_directory) # Changing the directory to the value of the variable "selected_directory" (directory of purchasing product)
    f = open(selected_product) # Opening the file with the value of the variable "selected_product" as the file name, assigning the contents to the variable "f"
    content = f.readlines() # Separating the contents & removing the newline comments from the contents of "f", assigning the contents to the variable "content"
    Label(screen51, text = "Product Name:").pack()
    Label(screen51, text = content[0]).pack() # Displaying to the user the product name
    Label(screen51, text = "Price:").pack()
    Label(screen51, text = content[1]).pack() # Displaying to the user the product price
    Label(screen51, text = "Quantity").pack()
    Label(screen51, text = content[2]).pack() # Displaying to the user the quantity remaining of the product
    Label(screen51, text = "Seller:").pack()
    Label(screen51, text = content[3]).pack() # Displaying to the user the seller of the product
    Label(screen51, text = "Category:").pack()
    Label(screen51, text = content[4]).pack() # Displaying to the user the product category
    Label(screen51, text = "Keyword 1:").pack()
    Label(screen51, text = content[5]).pack() # Displaying to the user the first keyword (of the product)
    Label(screen51, text = "Keyword 2:").pack()
    Label(screen51, text = content[6]).pack() # Displaying to the user the second keyword (of the product)
    Label(screen51, text = "Keyword 3:").pack()
    Label(screen51, text = content[7]).pack() # Displaying to the user the third keyword (of the product)
    Label(screen51, text = "Description:").pack()
    Label(screen51, text = content[8:-1]).pack() # Displaying to the user the description of the product
