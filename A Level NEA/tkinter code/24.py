...
def presence_checker():
    ...
    if presence_counter == 1:
      ...
      # If the value of "presence_counter" equals 9, it indicates that the username has not been entered (During the login process)
        print("Username has not been inputted")
        Label(screen46, text = "Username has not been inputted").pack() # Displaying message to user
        Label(screen46, text = "Please login again, inputting username")
        screen2.destroy() # Destroying the screen in which the user login (Directing user back to homepage)
    elif presence_counter == 10:
      # If the value of the "presence_counter" equals 10, it indicates that the password has not been entered (During the login process)
        print("Password has not been inputted")
        Label(screen46, text = "Password has not been inputted").pack() # Displaying message to user
        Label(screen46, text = "Please login again, inputting password").pack()
        screen2.destroy() # Destroying the login screen (Directing user back to homepage)
    elif presence_counter == 11:
      # If the value of "presence_counter" equals 11, it indicates that the memorable word has not been entered (During the login process)
        print("Memorable word has not been inputted")
        Label(screen46, text = "Memorable word has not been inputted").pack() # Displaying message to user
        Label(screen46, text = " Please login again, inputting your memorable word").pack()
        screen2.destroy() # Desrtoying the login screen (Directing user back to homepage)
    elif presence_counter == 12:
      # If the value of "presence_counter" equals 12, it indicates that the response to the memorable question has not been entered (During the login process)
        print("Memorable question has not been inputted")
        Label(screen46, text = "Memorable question has not been answered").pack() # Displaying message to user
        Label(screen46, text = "Please login again, inputting the answer to the memorable question").pack()
        screen2.destroy() # Destroying login screen
...
def login_verify():
    global username1 # Globalising the variable "username1" (User entered username)
    global password1 # Globalising the variable "password1" (User entered password)
    global memorable_word1 # Globalising the variable "memorable_word1" (User entered memorable word)
    global memorable_question1 # Globalising the variable "memorable_question1" (User entered response to memorable question)
    global ORIGINAL_ROOT_DIR # Globalising the variable "ORIGINAL_ROOT_DIR" (root directory)
    global username_info # Globalising the variable "username_info"
    global user_dir # Globalising the variale "user_dir" (User directory)
    global counter # Globalising the variable "counter" (counter for correct entries)
    global presence_counter # Globalising the variable "presence_counter" (Indicator for missing values)
    print(ORIGINAL_ROOT_DIR)
    username1 = username_verify.get() # Assigning the value of the variable "username_verify" to the variable "username1"
    password1 = password_verify.get() # Assigning the value of the variable "password_verify" to the variable "password1"
    memorable_word1 = memorable_word_verify.get() # Assigning the value of the variable "memorable_word_verify" to the variable "memorable_word1"
    memorable_question1 = memorable_question_verify.get() # Assigning the value of the variable "memorable_question_verify" to the variable "memorable_question1"
    password1 = str(password1) # Assigning the string value of the variable "password1" to the variable "password1"
    username1 = str(username1) # Assigning the string value of the variable "username1" to the variable "username1"
    memorable_word1 = str(memorable_word1) # Assigning the string value of the variable "memorable_word1" to the variable "memorable_word1"
    memorable_question1 = str(memorable_question1) # Assigning the string value of the variable "memorable_question1" to the variable "memorable_question1"
    username_entry1.delete(0, END) # Deleting the value held within the username entry field
    password_entry1.delete(0, END) # Deleting the value held within the password entry field
    memorable_word_entry1.delete(0, END) # Deleting the value held within the memorable word entry field
    memorable_question_entry1.delete(0, END) # Deleting the value held within the memorable question response entry field

    username1_length = len(username1) # Assigning the length of the variable "username1" to the variable "username1_length"
    password1_length = len(password1) # Assigning the length of the variable "password1" to the variable "password1_length"
    memorable_word1_length = len(memorable_word1) # Assigning the length of the variable "memorable_word1" to the variable "memorable_word1_length"
    memorable_question1_length = len(memorable_question1) # Assigning the length of the variable "memorable_question1" to the variable "memorable_question1_length"

    if username1_length == 0:
      # If the value of "username1_length" equals 0, it means that the user has not entered anyting for the username field
        presence_counter = 9 # Assigning the value "9" to the variable "presence_counter"
        presence_checker()
    elif password1_length == 0:
      # If the value of "password1_length" equals 0, it means that the user has not entered anything for the password field
        presence_counter = 10 # Assigning the value "10" to the variable "presence_counter"
        presence_checker()
    elif memorable_word1_length == 0:
      # If the value of "memorable_word1_length" equals 0, it means that the user has not entered anything for the memorable entry field
        presence_counter = 11 # Assigning the value "11" to the variable "presence_counter"
        presence_checker()
    elif memorable_question1_length == 0:
      # If the value of the variable "memorable_question1_length" equals 0, it means that the user has not entered anything for the response of the memorable question
        presence_counter = 12 # Assigning the value "12" to the variable "presence_counter"
        presence_checker()
    ...
    user_dir = os.path.join(ORIGINAL_ROOT_DIR, directory_for_users)
  # Through the os.path.join function, it concatenates the values of the variables "ORIGINAL_ROOT_DIR" and "directory_for_users"
  # Creating a new directory, within which user files will be stored
  # Assigning the value of the directory to the variable "user_dir"
    print(user_dir)

    counter = 0 # Assigning "0" to the variable "counter"
    counter = IntVar() # Declaring the variable "counter" as an integer
    
    os.chdir(user_dir) # Changing the directory to the value of the variable "user_dir"
    list_of_files = os.listdir()
    # Going through the current directory, storing all the file names into the variable "list_of_files"
    if username1 in list_of_files: # Initialising a conditional statement based on whether the value of the variable "username1" is in the data structure "list_of_files"
      # If the value of the variable "username1" is within the data structure "list_of_files", it means that this is a valid username that has already registered. Meaning the contents within this file would be used to compare the user entries
        file1 = open(username1, "r") # Opening the file with the value of the variable "username1" as the file name, assigning the contents to the variable "file1"
        verify = file1.read().splitlines()
      # Separating the contents from "file1" & removing the newline comments, assigning the updated comments to the variable "verify"
        their_password = verify[1] # Assigning the second value of the variable "verify" to the variable "their_password
        boolean_login = (password1 == verify[1]) # Assigning the value of either "True" or "False" depending on whether the value of the variables "password1" and "verify[1]" match
        print(boolean_login)
        #YOU ARE HERE, YOU NEED TO SEPARATELY VERIFY THE PASSWORD AND MEMORABLE
        #WORD AND MEMORABLE QUESTION
        if boolean_login == True: # Initialising a conditional statement based on the value of the variable "boolean_logic"
          # If the value of the variable "boolean_login" equals "True" it means that the user entered password and the stored password matches
          # Indicating the first out the required fields is correct, progressing to the next required field
            counter = 1 # Incrementing the value of the counter by 1
            print(counter)
        else:
          # If the value of the variable "boolean_login" does not equal "True", it means that the user entered password and the stored password does not match
          # Resulting in an unsuccessful attempt at logging in
            password_not_recognised()

        #their_memorable_word = verify[5]
        boolean_logic2 = (memorable_word1 == verify[5])
      # Assigning the value "True" or "False" to the variable "boolean_logic2" depending on whether the value of the variables "memorable_word1" and "verify[5]" match
        print(boolean_logic2)
        if boolean_logic2 == True: # Initialising a conditional statement based on the value of the variable "boolean_logic2"
          # If the value of the variable "boolean_logic2" equals True, it means that the user entered memorable word and the stored memorable word matches
          # Indicating that another required field has been answered successfully, progressing to the next required field
            counter = counter + 1 # Incrementing the value of the variable "counter" by one
            print(counter)
        else:
          # If the value of the variable "boolean_logic2" does not equal True, it means that the user entered memorable word and the stored memorable word does not match
          # Resulting in a unsuccessful login attempt
            password_not_recognised()

        boolean_logic3 = (memorable_question1 == verify[6])
      # Assigning the value of either "True" or "False" to the variable "boolean_logic3" depending on whether the values of the variables "memorable_question1" and "verify[6]" match
        print(boolean_logic3)
        if boolean_logic3 == True: # Initialising a conditional statement based on the value of the variable "boolean_logic3"
          # If the value of the variable "boolean_logic3" equals True, it means that the user entered response to the memorable question and the stored response to the memorable question match
          # Indicating that another of the required fields has a successful match
            counter = counter + 1 # Incrementing the value of the variable "counter" by one
            print(counter)
        else:
          # If the value of the variable "boolean_logic3" does not equal True, it means that the user entered resoinse to the memorable question and the stored response to the memorable question do not match
          # Resulting in an unsuccessful login attempt
            password_not_recognised()
        #their_memorable_question = verify[6]

        if counter == 3 and presence_counter != 0: # Initialising a conditional statement based on the values of the variables "counter" and "presence_counter"
          # If the value of the variable "counter" equals 3, it means that all the required fields for login are correct
          # If the value of the variable "presence_counter" equals 0, it means that there are no presence check errors
          # Once these conditions are met, the user should be able to login
            login_success()
        else:
          # If the value of the variable "counter" does not equal 3, it means that one of the required fields are incorrect, which means the user should not be able to login
          # If the value of the variable "presence_counter" does not equal 0, it means that there are some required fields that are missing, which means that the user should not be able to login
            password_not_recognised()
