...
def final_screen():
    ...
    if quantity == 0: # Initialising a conditional statement based on the value of the variable "quantity"
      ...
      # If the value of "quantity" does not equal 0, it means that there is a product to purchase
      # Meaning that the user should be able to purchase the product
        quantity = quantity - 1 # Reducing the value of "quantity" by 1
        print(quantity)
        ...
        content[2] = (q_data + "\n") # Assigning the value of the variable "q_data" to the third value of the data structure "content"
        quantity_write = open(purchasing_product, "w") # Opening the file with the value of the variable "purchasing_product" as the file name, assigning the contents to the variable "quantity_write"
        quantity_write.writelines(content) # Writing the contents of the variable "content" to the file (Writing updated quantity to the file)
        Label(screen38, text = "Item purchased, have fun").pack()
        print(username1)
        q = open(username1, "w") # Opening the file with the value of the variable "username1" as the file name, assigning the contents to the variable "q"
        print(q)
        q.write(purchasing_product + "\n") # Writing the value of the variable "purchasing_product" within the file
