...
def store_products():
    ...
    os.chdir(ORIGINAL_ROOT_DIR) # Changing the directory to the value of the variable "ORIGINAL_ROOT_DIR" (the root directory of where the .exe file is stored)
    ...
    # Through the os.path.join function, it concancenates the value of the variables "cwd" and "directory_for_products"
    # Creating a new directory, which would be used to store product files
    # Assigns the value of the directory to the variable "path_for_products"
    is_existing_products = os.path.exists(path_for_products)
    # Creates a boolean variable depending on whether the value of "path_for_products" is an existing directory
    if is_existing_products == True:
        # It means that the directory has already been created, so there is no need to create a new instance
        print("Doing nothing")
    else:
        # It means that the directory has yet to be created, which means that it needs to be created
        print("Creating the new directory")
        os.mkdir(path_for_products) # Creating the directory from the value of the variable "path_for_products"

    
    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigns the value of the current directory to the variable "cwd"
    directory_for_books = ("Books") # Assigns the value "Books" to the variable "directory_for_books"
    path_for_books = os.path.join(cwd, directory_for_books)
    # Through the os.paht.join function, it concancenates the value of the variables "cwd" and "directory_for_books"
    # Creating a new directory, which would be used to store products files that would have the category book
    # Assigns the value of the directory to the variable "path_for_books"


    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigns the value of the current directory to the variable "cwd"
    directory_for_games = ("Games") # Assigns the value "Games" to the variable "directory_for_games"
    path_for_games = os.path.join(cwd, directory_for_games)
    # Through the os.path.join function, it concancenates the value of the variables "cwd" and "directory_for_games"
    # Creating a new directory, which would be used to store product files that would have the category game
    # Assigning this value to the variable "path_for_games"


    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigns the value of the current directory to the variable "cwd"
    directory_for_electronics = ("Electronics") # Assigns the value "Electronics" to the variable "directory_for_electronics"
    path_for_electronics = os.path.join(cwd, directory_for_electronics)
    # Through the os.path.join function, it concancenates the values of the variables "cwd" and "directory_for_electronics"
    # Creating a new directory, which would be used to store product files that would have the category electronics
    # Assigning this value to the variable "path_for_electronics"
    

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigns the value of the current directory to the variable "cwd"
    directory_for_homegarden = ("Home") # Assigns the value "Home" to the variable "directory_for_homegarden"
    path_for_homegarden = os.path.join(cwd, directory_for_homegarden)
    # Through the os.path.join function, it concancenates the values of the variables "cwd" and "directory_for_homegarden"
    # Creating a new directory, which would be used to store product files that would have the category home & garden
    # Assigning this value to the variable "path_for_homegarden"
    print(path_for_homegarden)

    os.chdir(path_for_products) # Changing the directory to the value of the variable "path_for_products"
    cwd = os.getcwd() # Assigns the value of the current directory to the variable "cwd"
    directory_for_toys = ("Toys") # Assigns the value "Toys" to the variable "directory_for_toys"
    path_for_toys = os.path.join(cwd, directory_for_toys)
    # Through the os.path.join function, it concancenates the values of the variables "cwd" and "directory_for_toys"
    # Creating a new directory, which would be used to store product files that would have the category toys
    # Assigning this value to the variable "path_for_toys"
    print(path_for_toys)
    ...
    # Through the os.path.join function, it concancenates the values of the variables "cwd" and "directory_for_clothesjewellery"
    # Creating a new directory, which would be used to store product files that would have the category clothes & jewellery
    # Assigning this value to the variable "path_for_clothesjewellery"
    ...
    # Through the os.path.join function, it concancenates the values of the variables "cwd" and "directory_for_sportsoutdoors"
    # Creating a new directory, which would be used to store product files that would have the category sports & outdoors
    # Assigning this value to the variable "path_for_sportsoutdoors"
    ...
    # Through the os.path.join function, it concancenates the values of the variables "cwd" and "directory_for_food"
    # Creating a new directory, which would be used to store product files that would have the category food
    # Assigning this value to the variable "path_for_food"
    print(path_for_food)
    ...
    # Through the os.path.join function, it concancenates the values of the variable "cwd" and "directory_for_health"
    # Creating a new directory, which would be used to store product files that would have the category health
    # Assigning this value to the variable "path_for_health"
    ...
    # Through the os.path.join function, it concancenates the values of the variable "cwd" and "directory_for_motorvehicles"
    # Creating a new directory, which would be used to store product files that would have the category motor vehicles
    # Assigning this value to the variable "path_for_motorvehicles"
    ...
    # Through the os.path.join function, it concancenates the values of the variable "cwd" and "directory_for_education"
    # Creating a new directory, which would be used to store product files that would have the category education
    # Assigning this value to the variable "path_for_education"
    print(path_for_education)
    is_existing_education = os.path.exists(path_for_education)
    #Creating a boolean variable depending on whether the directory of the value of the variable "path_for_education" exists
    if is_existing_education == True:
        # If the value is "True", it means that that the education directory already exists, which means all other directories already exists
        print("Doing nothing")
    else:
        # If this value is "False", it means that the education directory does not exist
        #This means that all other directories would not exist and would need to be generated
        print("Creating the new directory")
