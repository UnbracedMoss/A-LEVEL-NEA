...
def login_verify():
    ...
    if username1 in list_of_files:
        ...
        if counter == 3 and presence_counter == 0: # Intialising a conditional statement based on the values of the variables "counter" and "presence_counter"
          # If the value of the variable "counter" equals 3, it means that all the required fields were correct
          # If the value of the variabe "presence_counter" equals 0, it means that there are no missing required entries
          # Meaning that the login process should be successful
            login_success()
            print(presence_counter)
        else:
          # If the value of the variable "counter" does not equal 3, it means that not all the required fields were correct
          # If the value of the variable "presence_counter" does not equal 0, it means that there were one or more missing required entries
          # Meaning that the login process should be terminated, displaying to the user what was incorrect
            print(presence_counter)
            password_not_recognised()
