...
def login_verify():
    ...
    global delete_counter # Globalising the variable "delete_counter" (to be used to determine which screen is deleted after login)
    delete_counter = StringVar() # Declaring the variable "delete_counter" as a string variable
    ...
    if username1 in list_of_files:
        ...
        if boolean_login == True:
          ...
          # This means that the user entered password is incorrect
          # User would need to be displayed this image
            global screen4 # Declaring a new screen
            screen4 = Toplevel(screen) # Making this screen appear at the top
            screen4.title("Password Error") # Defining the header of the screen
            screen4.geometry("550x500") # Defining the dimensions of the screen
            Label(screen4, text = "Password not recognised").pack()
            # Displaying to the user that they have entered the wrong password
            delete_counter = 3 # Assigning the value "3" to the variable "delete_counter" (So that this screen will be deleted)
        ...
        if boolean_logic2 == True:
          ...
          # This means that the user has not entered an accurate response to the memorable word
            global screen48 # Declaring a new screen
            screen48 = Toplevel(screen) # Making this screen appear at the top
            screen48.title("Memorable word error") # Defining the header of the screen
            screen48.geometry("550x500") # Defining the dimensions of the screen
            Label(screen48, text = "Incorrect response to memorable word").pack()
          # Displaying to the user that they have incorrectly responded to the memorable word
            delete_counter = 48 # Assigning the value "48" to the variable "delete_counter" (To indicate that this screen needs deletion)
...
def forgotten_password_verify():
    ...
    global forgotten_password_counter # Globalising the variable "forgotten_password_counter" (To later indicate what screen is to be deleted)
    forgotten_password_counter = StringVar() # Declaring the variable "forgotten_password_counter" as a string
    forgotten_password_counter = 1 # Assigning the value "1" to the variable "forgotten_password_counter"
...
def session():
    ...
    global forgotten_password_counter # Globalising the variable "forgotten_password_counter"
    if forgotten_password_counter == 1: # Initialising a conditional statement based on the value of the variable "forgotten_password_counter"
      # If the value of the variable "forgotten_password_counter" equals 1, it means that the user has logged in through the forgotten_password() function, which means that screen needs to be deleted
        screen47.destroy()
    else:
      # If the value of the variable "forgotten_password_counter" does not equal 1, it means that the user has logged in through the main system, meaning the appropriate screen has already been deleted
