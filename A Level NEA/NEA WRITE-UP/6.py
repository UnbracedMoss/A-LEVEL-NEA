...
def buying():
    global screen8 # Declaring a new screen
    screen8 = Toplevel(screen) # Making this screen appear at the top
    screen8.title("Buying Homepage") # Defining the header of this screen
    screen8.geometry("500x500") # Defining the dimensions of the screen
    ...
    books_button.pack() # Directing code to the books() function if users want to search through all the books available

    games_button = Button(screen8, text = "Games", command = games)
    games_button.pack() # Directing code to the games() function if users want to search through all the games available

    electronics_button = Button(screen8, text = "Electronics", command = electronics)
    electronics_button.pack() # Directing code to the electronics() function if users want to search through all the electronics available

    home_garden_button = Button(screen8, text = "Home & Garden", command = home_garden)
    home_garden_button.pack() # Directing code to the home_garden() function if tusers want to search through all the home & garden products available

    toys_button = Button(screen8, text = "Toys", command = toys)
    toys_button.pack() # Directing code to the toys() function if users want to search through all the toys available

    clothes_jewellery_button = Button(screen8, text = "Clothes & Jewellery", command = clothes_jewellery)
    clothes_jewellery_button.pack() # Directing code to the clothes_jewellery() function if users want to search though all the clothes & jewellery available

    sports_outdoors_button = Button(screen8, text = "Sports & Outdoors", command = sports_outdoors)
    sports_outdoors_button.pack() # Directing code to the sports_outdoors() function if users want to search through sports & outdoors products

    food_button = Button(screen8, text = "Food", command = food)
    food_button.pack() # Directing code to the food() function if users want to search through all the food products available

    health_button = Button(screen8, text = "Health", command = health)
    health_button.pack() # Directing code to the health() function if the user wants to search though all the health products available

    motor_vehicles_button = Button(screen8, text = "Motor Vehicles", command = motor_vehicles)
    motor_vehicles_button.pack() # Directing code to the motor_vehicles() function if the user wants to search though all motor vehicles

    education_button = Button(screen8, text = "Education", command = education)
    education_button.pack() # Directing code to the education() function, if the user wants to search though all products related to education
    #new code ends----------------------------------------------------------------------------------------------------------------------------------------------
