...
def main_screen():
    ...
    # Through the os.path.join function, it concatenates the value of the variables "cwd" and "directory_for_health"
    # Creating a directory, where all the product files with the category "Health" would be stored
    # Assigning the value of the directory to be stored to the variable "path_for_health"
    ...
    # Creating a directory, within which, all product files with the category "Motor vehicles" will be stored
    # Assigning the value of the directory to the variable "path_for_motorvehicles"
    ...
    # Creating a directory, within which, all product files with the category "Education" will be stored
    # Assigning the value of the directory to the variable "path_for_education"
    print(path_for_education)
    
    
    is_existing_education = os.path.exists(path_for_education)
    #Creating a boolean variable with a value depending on whether a directory with the value of the variable "path_for_education" existing
    

    if is_existing_education == True: # Intialising a conditional statement depending on the value of the variable "is_existing_education"
        # If "True", it means that the education directory as well as all other directories would have already been created
        # Meaning there is no need to generate those directories
        print("Doing nothing")
    else:
        # If "False", it means that the education directory as well as all other directories have yet to been generated
        # This means that those directories would have to be created.
        print("Creating the new directory")
        #new code------------------------------------------------------------------------------------------------------
        os.mkdir(path_for_books) # Making a directory with the value of the variable "path_for_books"
        #new code ends--------------------------------------------------------------------------------------------------
        os.mkdir(path_for_games) # Making a directory with the value of the variable "path_for_games"
        os.mkdir(path_for_electronics) # Making a directory with the value of the variable "path_for_electronics"
        os.mkdir(path_for_homegarden) # Making a directory with the value of the variable "path_for_homegarden"
        os.mkdir(path_for_toys) # Making a directory with the value of the variable "path_for_toys"
        os.mkdir(path_for_clothesjewellery) # Making a directory with the value of the variable "path_for_clothesjewellery"
        os.mkdir(path_for_sportsoutdoors) # Making a directory with the value of the variable "path_for_sportsoutdoors"
        os.mkdir(path_for_food) # Making a directory with the value of the variable "path_for_food"
        os.mkdir(path_for_health) # Making a directory with the value of the variable "path_for_health"
        os.mkdir(path_for_motorvehicles) # Making a directory with the value of the variable "path_for_motorvehicles"
        os.mkdir(path_for_education) # Making a directory with the value of the variable "path_for_education"
        print("Made new directory")
